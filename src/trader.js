...
function onIntent(intentRequest, session, callback) {
    ...
    if ("GetQuote" === intentName) {
        handleDefinitionRequest(intent, session, callback);
    } 
}
...
function getWelcomeResponse(callback) {
    ...
    var sessionAttributes = {},
        //CHANGE THIS TEXT
        speechOutput = "What stock are you interested in?",
...
function handleDefinitionRequest(intent, session, callback) {
    ...
    getContent(DEFINE_ENDPOINT + encodeURIComponent(stock))
          ...
          .then((response) => callback(sessionAttributes, response));
}

// ------- Helper functions to build responses -------

function definitionResponse(definition) {
    return {
        outputSpeech: {
            type: 'PlainText',
            text: definition
